...
impl Database {
    ...
    async fn list(&self) -> Result<Vec<crate::models::BadWord>, anyhow::Error> {
        ...
        self.0
            .asyncify(move |c| Ok(dsl::bad_words.load::<crate::models::BadWord>(c)?))
            .await
    }
    ...
    async fn edit(&self, word: &str, why: Option<&str>) -> Result<(), anyhow::Error> {
        ...
        self.0
            .asyncify(move |c| {
                ...
                let b = filter.first::<crate::models::BadWord>(c).optional()?;

                match b {
                    None => {
                        let bad_word = crate::models::BadWord { word, why };
