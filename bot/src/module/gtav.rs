...
impl fmt::Display for Command {
    fn fmt(&self, fmt: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        match self {
            ...
            SuperSpeed(n) => write!(fmt, "SUPER SPEED for {n} seconds monkaSpeed"),
            SuperSwim(n) => write!(fmt, "SUPER SWIM for {n} seconds monkaSpeed"),
            SuperJump(n) => write!(fmt, "SUPER JUMP for {n} seconds monkaS"),
            Invincibility(n) => write!(
                fmt,
                "giving them invincibility for {n} seconds FeelsGoodMan",
            ),
            SpawnEnemy(1) => write!(fmt, "spawning an enemy monkaS"),
            SpawnEnemy(n) => write!(fmt, "spawning {n} enemies monkaS"),
